...
const Product = () => {
  ...
  return (
  <div id="products" className="flex flex-col pt-8 text-black">
  <div className="pb-16">
  ...
  <div className="flex flex-wrap gap-8 p-6 pt-16 justify-center">
    {products.map((product, index) => (
      <motion.div
        key={product.id}
        className="w-full sm:w-72 bg-white overflow-hidden rounded-lg shadow-md text-black"
  ...
  <div className="pt-16">
    <motion.a
      href="#"
      className="flex justify-center cursor-pointer border-b-2 border-black w-max mx-auto font-semibold text-lg text-black"
